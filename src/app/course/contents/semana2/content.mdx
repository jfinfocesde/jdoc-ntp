...
<Link href="https://www.python.org/" target='_blank'>`https://www.python.org/`</Link>
...
Tabla HTML: Lenguajes Compilados vs. Lenguajes Interpretados
...
<table>
  <thead>
    <tr>
      <th>Criterio</th>
      <th>Lenguajes compilados</th>
      <th>Lenguajes interpretados</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Ejemplos</td>
      <td>C, C++, Rust, Go, Haskell</td>
      <td>Python, Ruby, JavaScript, PHP</td>
    </tr>
    <tr>
      <td>Traducción</td>
      <td>Se realiza una vez, antes de la ejecución</td>
      <td>Se realiza cada vez que se ejecuta el programa</td>
    </tr>
    <tr>
      <td>Velocidad</td>
      <td>Suelen ser más rápidos y eficientes</td>
      <td>Suelen ser más lentos y consumir más recursos</td>
    </tr>
    <tr>
      <td>Portabilidad</td>
      <td>Dependen de la plataforma y el compilador</td>
      <td>Son independientes de la plataforma y el intérprete</td>
    </tr>
    <tr>
      <td>Depuración</td>
      <td>Es más difícil encontrar y corregir errores</td>
      <td>Es más fácil encontrar y corregir errores</td>
    </tr>
    <tr>
      <td>Flexibilidad</td>
      <td>Suelen ser más rígidos y estrictos</td>
      <td>Suelen ser más dinámicos y flexibles</td>
    </tr>
    <tr>
      <td>Control</td>
      <td>Permiten un mayor control sobre el hardware</td>
      <td>Abstraen el hardware y lo gestionan automáticamente</td>
    </tr>
    <tr>
      <td>Tamaño</td>
      <td>Suelen generar archivos ejecutables más grandes</td>
      <td>Suelen generar archivos de código fuente más pequeños</td>
    </tr>
  </tbody>
</table>


<Link href="https://ed.team/blog/lenguajes-de-programacion-compilados-vs-interpretados" target='_blank'>Más información acerca de lenguajes interpretados</Link>
...
<Row>
<Col span={24}>
<iframe  style={{ width: '100%', height: '400px' }} src="https://www.youtube.com/embed/m5i-Pq-z9w8" title="🔴CÓMO Descargar e Instalar Python3 - 2022 👉 en Windows 11" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</Col>
</Row>
...
<Row>
<Col span={24}>
<iframe  style={{ width: '100%', height: '400px' }} src="https://www.youtube.com/embed/UPya-XsUlA4" title="🔴CÓMO Descargar e Instalar Python3 - 2022 👉 en Windows 11" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</Col>
</Row>
